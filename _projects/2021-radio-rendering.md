...
![Load and Boundary Conditions]({{ '/assets/images/Wrench-Boundary-Condition_Analysis.png' | relative_url }})
...
![Max Principal Stress Contours]({{ '/assets/images/Wrench-FEM-Maximum-Principal-Principal-Stress-Contours.png' | relative_url }})
